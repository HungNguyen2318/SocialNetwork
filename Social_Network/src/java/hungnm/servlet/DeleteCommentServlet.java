...
public class DeleteCommentServlet extends HttpServlet {
    ...
    final static Logger LOG = Logger.getLogger(DeleteCommentServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {           
            ...
            url = ERROR_PAGE;
            LOG.error("NamingException at DeleteCommentServlet: " + ex.getMessage());
        } catch (SQLException ex) {
            url = ERROR_PAGE;
            LOG.error("SQLException at DeleteCommentServlet: " + ex.getMessage());
        } finally {
